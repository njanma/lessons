...
2. Создать классы Warrior, Wizard и Archer, представляющие собой наследников класса Hero
...
    Переопределить метод в подклассах Warrior, Wizard и Archer так, чтобы каждый герой наносил врагу разное количество урона.
