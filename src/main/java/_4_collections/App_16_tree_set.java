...
public class App_16_tree_set {
    public static void main(String[] args) {
        Set<String> treeSet = new TreeSet<>(asList("CCC", "AAA", "BBB", "AAA"));
        Set<String> hashSet = new HashSet<>(asList("CCC", "AAA", "BBB", "AAA"));
        List<String> listOrdered = asList("CCC", "AAA", "BBB", "AAA");
